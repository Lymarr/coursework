    ...
    public partial class Form1 : Form
    {
        ...
        async void Downloader_BackProcess_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            async Task DownloadWork(string link, int playlist = -1)
            {
                ...
                ConvertMp3ToWav(txtFilePath.Text + Targetaudio.ToList()[0].Title + ".mp3", txtFilePath.Text + Targetaudio.ToList()[0].Title + ".wav");
                FileDelete(txtFilePath.Text + Targetaudio.ToList()[0].Title + ".mp3");
                await au;
